...
//increase the speed of mainvideo
document.getElementById('mainvideo').playbackRate = 1.5; // Speed up 2x

// Rotating Keywords Animation
const keywords = ['Quality.', 'Precision.', 'Durability.', 'Innovation.'];
const rotatingSpan = document.querySelector('.rotating-keywords');
let keywordIndex = 0;
setInterval(() => {
  rotatingSpan.textContent = keywords[keywordIndex];
